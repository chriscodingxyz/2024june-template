...
export default function ZustandCounterServer() {
  ...
  return (
    <main className="px-2 border-4 border-primary flex-center-col mx-auto shadow-[8px_8px_0px_0px_#9f9f9f] border-dashed bg-orange-300 hover:border-solid hover:opacity-85">
